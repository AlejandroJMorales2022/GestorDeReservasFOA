...
const imprimirReservasPorFechaIn=()=>{
    //Mapeo el array original para que el sort (ordenaiento) no lo destruya
    const arrayReservasPorFechaIn = arrayReservas.map ( (reserva =>{
        return{    
            nro:reserva.nro,
            dni:reserva.dni,
...
while((opcionElegida>=1 && opcionElegida<=7)|| opcionElegida!=8){
